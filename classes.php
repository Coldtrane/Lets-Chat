...
<?php
    ...
    class user{
        ...
        public function setUserName($UserName){
            ...
            $UserName = ucfirst(strtolower($UserName)); // NEW TO FORMAT USERNAME
    ...
    public function DisplayMessage(){
        ...
        while($DataChat=$ChatReq->fetch()){
            ...
            ?>
                ...
                <span class="User_Names"><?php echo $DataUser['UserName'] ;?> </span> <strong style="color: yellow;"> Says:</strong><br>

                <span class="User_Messages" style="color: red; background-color: #f1f1f1; border-radius: 5px; padding: 1.5px; margin: 10px; border: 2px solid #dedede;"><?php echo htmlspecialchars($DataChat['ChatText']);?></span>
                <br><br>
                <?php
